...
Route::get('pay-khalti', 'KhaltiPaymentController@payment_process')->name('pay-khalti');
Route::get('pay-khalti/success', 'KhaltiPaymentController@success')->name('pay-khalti.success');
Route::get('pay-khalti/fail', 'KhaltiPaymentController@fail')->name('pay-khalti.fail');
